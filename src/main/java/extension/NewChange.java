...
public class NewChange {
    ...
    public NewChange(final String path, final String struture, final Category category, final Boolean isBreakingChange, final String description) {
        this.path = path;
    ...
    public NewChange(final String path, final String struture, final Category category, final Boolean isBreakingChange) {
        this.path = path;
        this.element = struture;
        this.category = category;
        this.breakingChange = isBreakingChange;
    ...
    public NewChange(final String path, final String struture, final Category category) {
        this.path = path;
        this.element = struture;
        this.category = category;
    }
