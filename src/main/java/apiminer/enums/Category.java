...
public enum Category {
    ...
    TYPE_EXTRACT_TYPE("Extract Type"),
    TYPE_EXTRACT_SUBTYPE("Extract Subtype"),
    ...
    METHOD_MOVE_AND_RENAME("Move and Rename Method"),
    ...
    FIELD_ADD("Add Field"),
    FIELD_MOVE_AND_RENAME("Move and Rename Field"),
    FIELD_EXTRACT("Extract Field"),
    ...
    Category(final String displayName, final Boolean isBreakingChange) {
