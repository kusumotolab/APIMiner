...
public class DeprecateTypeChange extends ClassChange {
    private UMLClass originalClass;
    private UMLClass nextClass;

    public DeprecateTypeChange(UMLClass originalClass, UMLClass nextClass, Category category, RevCommit revCommit) {
        super(revCommit);
