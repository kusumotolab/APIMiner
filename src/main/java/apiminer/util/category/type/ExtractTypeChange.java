...
public class ExtractTypeChange extends ClassChange {
    private UMLClass extractedClass;
    private UMLClass originalClass;

    public ExtractTypeChange(RefactoringElement refactoringElement, RevCommit revCommit){
        super(revCommit);
    ...
    private String isDescription(){
        String message = "";
        message += "<br>extract type <code>" + extractedClass.getName() + "</code>";
